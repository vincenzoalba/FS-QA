...
$\rho_n^*$ (cf.~\eref{rho_sp} for the results up to $n=3$). Note that its position 
...
(cf.~\eref{rho_sp}) $\pmb{\rho}=\{\rho_n(\lambda)\}_{n=1}^{\infty}$ can be extracted 
